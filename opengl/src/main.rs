...
// objects to render
    ...
    let mut cube = Object::new(&cube_vertices, &cube_indices, cube_center);
    let cube2 = Object::new(&cube_vertices, &cube_indices, Vec3::new(0.,0.,0.));
...
// values for projection
    ...
    'running: loop {
        ...
        unsafe {
            ...
            cube.render(&u_model_matrix);
            cube2.render(&u_model_matrix);
        }
