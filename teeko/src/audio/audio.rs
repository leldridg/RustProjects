...
impl AudioSystem {
    pub fn new() -> Self {
        ...
        chunks.insert(Message::DoMove, mixer::Chunk::from_file("sfx/click_on.mp3").unwrap());
        chunks.insert(Message::UndoMove, mixer::Chunk::from_file("sfx/click_off.mp3").unwrap());
    ...
    pub fn update(&mut self) {
        ...
        for i in 0..self.system.message_queue.len() {
            ...
            mixer::Channel::play(self.channel, &self.chunks[&message], 0).unwrap();
        }
